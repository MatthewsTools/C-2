...
struct sizeof_expr* csq::tree::get_sizeof_expr_mem()
{
  struct sizeof_expr* newexpr = new struct sizeof_expr;
  return newexpr;
}

void csq::tree::delete_sizeof_expr(struct sizeof_expr** soexpr)
{
...
struct cast_expr* csq::tree::get_cast_expr_mem()
{
  struct cast_expr* newexpr = new struct cast_expr;
  return newexpr;
}

void csq::tree::delete_cast_expr(struct cast_expr** cexpr)
{
...
struct primary_expr* csq::tree::get_primary_expr_mem()
{
...
void csq::tree::get_inorder_primary_expr(struct primary_expr** pexpr)
{
...
void csq::tree::delete_primary_expr(struct primary_expr** pexpr)
{
...
struct id_expr* csq::tree::get_id_expr_mem()
{
...
void csq::tree::delete_id_expr(struct id_expr** idexpr)
{
...
struct expr* csq::tree::get_expr_mem()
{
...
void csq::tree::delete_expr(struct expr** exp)
{
...
struct assgn_expr* csq::tree::get_assgn_expr_mem()
{
...
void csq::tree::delete_assgn_expr(struct assgn_expr** exp)
{
  if(*exp == nullptr) return;
...
struct func_call_expr* csq::tree::get_func_call_expr_mem()
{
...
void csq::tree::delete_func_call_expr(struct func_call_expr** exp)
{
...
struct asm_operand* csq::tree::get_asm_operand_mem()
{
...
void csq::tree::delete_asm_operand(struct asm_operand** asmop)
{
...
struct labled_stmt* csq::tree::get_label_stmt_mem()
{
  struct labled_stmt* newstmt = new struct labled_stmt;
  return newstmt;
}

struct expr_stmt* csq::tree::get_expr_stmt_mem()
{
...
struct select_stmt* csq::tree::get_select_stmt_mem()
{
...
struct iter_stmt* csq::tree::get_iter_stmt_mem()
{
...
struct jump_stmt* csq::tree::get_jump_stmt_mem()
{
...
struct asm_stmt* csq::tree::get_asm_stmt_mem()
{
...
struct stmt* csq::tree::get_stmt_mem()
{
...
struct tree_node* csq::tree::get_tree_node_mem()
{
  struct tree_node* newtr = new struct tree_node;
  newtr->symtab = csq::symtable::get_node_mem();
...
void csq::tree::delete_label_stmt(struct labled_stmt** lbstmt)
{
...
void csq::tree::delete_asm_stmt(struct asm_stmt** asmstmt)
{
...
void csq::tree::delete_expr_stmt(struct expr_stmt** expstmt)
{
...
void csq::tree::delete_select_stmt(struct select_stmt** selstmt)
{
...
void csq::tree::delete_iter_stmt(struct iter_stmt** itstmt)
{
...
void csq::tree::delete_jump_stmt(struct jump_stmt** jmpstmt)
{
...
void csq::tree::delete_stmt(struct stmt** stm)
{
...
void csq::tree::delete_tree(struct tree_node** tr)
{
  ...
  while(curr != nullptr){
    ...
    if(curr->symtab != nullptr){
      csq::symtable::delete_node(&curr->symtab);
    }
    curr->p_prev = nullptr;
    curr->p_next = nullptr;
    delete curr;
...
void csq::tree::delete_tree_node(struct tree_node** trn)
{
...
void csq::tree::add_asm_statement(struct asm_stmt** ststart, struct asm_stmt** asmstmt)
{
...
void csq::tree::add_statement(struct stmt** ststart, struct stmt** _stmt)
{
...
void csq::tree::add_tree_node(struct tree_node** trstart, struct tree_node** _trn)
{
