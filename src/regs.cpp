...
std::pair<int, int> csq::regs::size_indexes(int sz)
{
  if(sz == 1){
...
bool csq::regs::search_register(regs_t rt)
{
...
bool csq::regs::search_fregister(fregs_t rt)
{
...
regs_t csq::regs::allocate_register(int dsize)
{
...
fregs_t csq::regs::allocate_float_register()
{
  int reg;
  for(reg = 0; reg <= 7; ++reg){
...
void csq::regs::free_register(regs_t rt)
{
...
void csq::regs::free_float_register(fregs_t rt)
{
...
void csq::regs::free_all_registers()
{
  locked_registers.clear();
}

void csq::regs::free_all_float_registers()
{
