...
/* Start of print white bold text functions */
void csq::print::print_white_bold_text(std::string str)
{
  /*
    Change the color to bold white, then print "str" (the text
    argument), and then change the color back to regular text.
  */
  std::cout << "\033[1;38m" << str;
  std::cout << "\033[0m";
}

void csq::print::print_white_bold_text(std::vector<token>& v)
{
...
void csq::print::print_white_bold_text(std::list<token>& lst)
{
...
/* End of the white bold text print functions */

/* Start of print red bold text function */
void csq::print::print_red_bold_text(std::string str)
{
  /*
    Change the color to bold red, print "str", and
    then change the color of the text back to what
    it was.
  */
  std::cout<<"\033[1;31m"<<str;
  std::cout<<"\033[0m";
}
/* End of print red bold text function */

void csq::print::print_spaces(int n)
{
  while(n>0){
    std::cout<<" ";
    n--;
...
void csq::print::mark_error(int n)
{
  print_spaces(n);
  print_red_bold_text("~~~^");
  std::cout<<std::endl;
...
void csq::print::print_type_info(struct st_type_info* tyinf)
{
  size_t i;
...
void csq::print::print_rec_type_info(struct st_rec_type_info* tyinf)
{
  size_t i;
  if(tyinf == nullptr) return;
...
void csq::print::print_record(struct st_record_node* rec)
{
...
void csq::print::print_symbol_info(struct st_symbol_info* si)
{
...
void csq::print::print_func_param_info(struct st_func_param_info* fpi)
{
...
void csq::print::print_func_info(struct st_func_info* fi)
{
...
void csq::print::print_symtab(struct st_node* symtb)
{
  int i;
...
void csq::print::print_record_symtab(struct st_record_symtab* recsym)
{
  int i;
...
void csq::print::print_sizeof_expr(struct sizeof_expr* expr)
{
  size_t i;
  if(expr == nullptr)
    return;
...
void csq::print::print_cast_expr(struct cast_expr* expr)
{
  size_t i;
  if(expr == nullptr)
    return;
...
void csq::print::print_primary_expr_tree(struct primary_expr* expr)
{
  if(expr==nullptr)
    return;
  std::cout<<"{\n";
...
void csq::print::print_primary_expr(struct primary_expr* expr)
{
  std::cout<<"(primary expression : "<<expr<<")"<<std::endl;
  print_primary_expr_tree(expr);
}

void csq::print::print_id_expr_tree(struct id_expr* expr)
{
  if(expr==nullptr)
    return;
  std::cout<<"{\n";
...
void csq::print::print_id_expr(struct id_expr* expr)
{
  std::cout<<"(id expression : "<<expr<<")"<<std::endl;
  print_id_expr_tree(expr);
}

void csq::print::print_assgn_expr(struct assgn_expr* expr)
{
...
void csq::print::print_func_call_expr(struct func_call_expr* expr)
{
...
std::string csq::print::get_expr_type(expr_t ext)
{
  switch(ext){
    case PRIMARY_EXPR :
      return "primary expr";
...
void csq::print::print_expr(struct expr*  exp)
{
...
void csq::print::print_labled_statement(struct labled_stmt* lbstm)
{
...
void csq::print::print_expr_statement(struct expr_stmt* exstm)
{
...
void csq::print::print_select_statement(struct select_stmt* selstm)
{
...
void csq::print::print_iter_statement(struct iter_stmt* itstm)
{
...
void csq::print::print_jump_statement(struct jump_stmt* jmpstm)
{
...
void csq::print::print_asm_operand(struct asm_operand* asmopr)
{
...
void csq::print::print_asm_statement(struct asm_stmt* asmstmt)
{
...
void csq::print::print_statement(struct stmt* stm)
{
...
void csq::print::print_tree(struct tree_node* tr, bool print_symtab)
{
  ...
  while(curr != nullptr){
    ...
    std::cout<<"p_prev : "<<curr->p_prev<<std::endl;
    if(print_symtab){
      csq::print::print_func_info(curr->symtab->func_info);
      csq::print::print_symtab(curr->symtab);
    }
